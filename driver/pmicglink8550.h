...
EVT_WDF_IO_QUEUE_IO_INTERNAL_DEVICE_CONTROL PmicGlinkEvtIoInternalDeviceControl;
...
EVT_WDF_DEVICE_SELF_MANAGED_IO_SUSPEND PmicGlinkEvtSelfManagedIoSuspend;
